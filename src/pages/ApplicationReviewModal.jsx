...
const ApplicationReviewModal = ({ isOpen, onClose, appData }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const sessionId = appData.sessionId || appData.session_id || appData.session || sessionStorage.getItem("dex_session_id") || '';
      const dexPayload = JSON.stringify({ "ApplicantID": appData.id, "SessionID": sessionId });
      try {
